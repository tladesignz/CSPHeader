...
Pod::Spec.new do |s|
  s.name             = 'CSPHeader'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CSPHeader.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Benjamin Erhart/CSPHeader'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Benjamin Erhart' => 'berhart@netzarchitekten.com' }
  s.source           = { :git => 'https://github.com/Benjamin Erhart/CSPHeader.git', :tag => s.version.to_s }
